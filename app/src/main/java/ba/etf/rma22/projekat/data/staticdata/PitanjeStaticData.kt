...
fun pitanja() : List<Pitanje>{
    return listOf(
        ...
        Pitanje("4", "DA ili NE: Michael Jackson je 1984. dobio nagradu Grammy za rekord godine za pjesmu 'Beat It'?", listOf("Da", "Ne")),
        Pitanje("5", "Koji je hemijski simbol za zlato?", listOf("Al", "Ag", "Au")),
        Pitanje("6", "Ko pjeva pjesmu 'Djevojka sa 'Cardas' nogama'?", listOf("Kemal Monteno", "Đorđe Balašević", "Dino Merlin")),
        Pitanje("7", "Grčki bog Sunca je:", listOf("Had", "Posejdon", "Helije")),
